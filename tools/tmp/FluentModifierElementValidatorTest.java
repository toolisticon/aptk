...
import io.toolisticon.aptk.tools.fluentvalidator.FluentValidators;
import io.toolisticon.aptk.validators.FluentModifierElementValidator;
                                ...
                                AnnotationProcessorUnitTestConfigurationBuilder.createTestConfig()
                                        ...
                                        .setProcessor(new AbstractUnitTestAnnotationProcessorClass() {
                                            ...
                                            protected void testCase(TypeElement element) {
                                                ...
                                                MatcherAssert.assertThat(FluentElementValidator.createFluentElementValidator(testElement).applyValidator(FluentValidators.MODIFIER_VALIDATOR).hasAllOf(Modifier.SYNCHRONIZED, Modifier.PUBLIC).applyValidator(FluentValidators.MODIFIER_VALIDATOR).hasNoneOf(Modifier.PROTECTED, Modifier.FINAL).justValidate(), Matchers.is(true));
