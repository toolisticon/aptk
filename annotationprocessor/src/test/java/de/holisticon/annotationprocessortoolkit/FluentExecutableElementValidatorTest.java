...

                        {
                                ...
                                new AbstractAnnotationProcessorTestBaseClass.AbstractTestAnnotationProcessorClass() {
                                    ...
                                    protected void testCase(TypeElement element) {
                                        ...
                                        getTypeUtils().doTypeRetrieval().getTypeElement(AbstractAnnotationProcessorTestBaseClass.AbstractTestAnnotationProcessorClass.class);
                        ...
                        },
                        {
                                ...
                                new AbstractAnnotationProcessorTestBaseClass.AbstractTestAnnotationProcessorClass() {
                                    ...
                                    protected void testCase(TypeElement element) {
                                        ...
                                        // check null value
                                        List<? extends Element> elements = createFluentElementFilter(ElementUtils.AccessEnclosedElements.getEnclosedElementsByName(element, "methodWithReturnTypeAndParameters"))
                                                .applyFilter(Filters.getElementKindFilter()).filterByOneOf(ElementKind.METHOD)
                                                .getResult();
