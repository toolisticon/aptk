...
public class GenericMatcherTest {
    ...
    public void testHasOf_AtLeastOneOf() {
        ...
        GenericElementCharacteristicValidator<Modifier> spy = Mockito.spy((GenericElementCharacteristicValidator<Modifier>) io.toolisticon.aptk.tools.characteristicsvalidator.Validators.InAndExclusiveElementValidators.getModifierValidator());
