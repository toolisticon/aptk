...
public class ParentElementTransitionFilterTest extends AbstractAnnotationProcessorUnitTest {
    ...
    public ParentElementTransitionFilterTest(String message, AnnotationProcessorUnitTestConfiguration configuration) {
        super(configuration);
    }
    ...
    public static List<Object[]> data() {
        return Arrays.asList(
                ...
                new Object[][]{
                        ...
                        {
                                "ParentElementTransitionFilter test - test transition with multiple input elements",
                                AnnotationProcessorUnitTestConfigurationBuilder.createTestConfig()
                                        .compilationShouldSucceed()
                                        .setProcessor(new AbstractUnitTestAnnotationProcessorClass() {
                                                          @Override
