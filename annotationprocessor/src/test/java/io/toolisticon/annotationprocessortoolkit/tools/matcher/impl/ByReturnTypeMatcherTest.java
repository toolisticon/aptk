...
/**
 * Unit test for {@link ByReturnTypeMatcher}.
 */
@RunWith(Parameterized.class)
public class ByReturnTypeMatcherTest extends AbstractAnnotationProcessorUnitTest {

    public ByReturnTypeMatcherTest(String message, AnnotationProcessorUnitTestConfiguration configuration) {
        super(configuration);
    }
