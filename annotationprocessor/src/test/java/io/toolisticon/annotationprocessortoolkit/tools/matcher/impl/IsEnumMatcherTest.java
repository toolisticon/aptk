...
public class IsEnumMatcherTest extends AbstractAnnotationProcessorUnitTest {

    public IsEnumMatcherTest(String message, AnnotationProcessorUnitTestConfiguration configuration) {
        super(configuration);
    }
