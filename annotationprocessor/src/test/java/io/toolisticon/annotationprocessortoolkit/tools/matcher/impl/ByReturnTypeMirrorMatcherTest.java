...
public class ByReturnTypeMirrorMatcherTest extends AbstractAnnotationProcessorUnitTest {

    public ByReturnTypeMirrorMatcherTest(String message, AnnotationProcessorUnitTestConfiguration configuration) {
        super(configuration);
    }
