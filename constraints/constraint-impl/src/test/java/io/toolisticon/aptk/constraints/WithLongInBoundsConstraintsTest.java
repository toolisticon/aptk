...
/**
 * Unit test for {@link WithLongInBoundsConstraintImpl}.
 */
public class WithLongInBoundsConstraintsTest {
    ...
    @interface WithInclusiveUpperAndLowerBound {
        ...
        @WithLongInBounds(lowerBound = 5, upperBound = 10) long value();
    ...
    @interface WithExclusiveUpperAndLowerBound {
        ...
        @WithLongInBounds(lowerBound = 5, inclusiveLowerBound = false, upperBound = 10, inclusiveUpperBound = false) long value();
    ...
    public void exclusive_low_happyPath() {
        Cute.unitTest().when().passInElement().fromClass(WithExclusiveUpperAndLowerBound_low_Match.class).intoUnitTest((procEnv, e) -> {
            ...
            try {
                ...
                .andThat().compilerMessage().ofKindError().contains(BasicConstraintsCompilerMessages.WITHLONGBOUNDS_ERROR_WRONG_USAGE.getCode())
                .executeTest();
    }
